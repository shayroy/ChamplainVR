...
schools. Attributes or properties describe the student, such as name, height, gender, phone number, program. Registered
...
For a class called calculator, number1 and number2 are properties, and adding them is method. The numbers and
 add capacity are encapsulated within
...
For BookLoan, properties are loan date, due date, Book (also a class), Member (also a class).
